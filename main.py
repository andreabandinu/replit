...
st.caption("Note: This dashboard uses real stock data fetched using the yfinance library. The Monte Carlo simulation for VaR, Expected Shortfall, and Conditional Value at Risk (CVaR) provides a robust estimation of potential losses under various market scenarios.")
